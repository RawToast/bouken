...
module Builder: WorldBuilder = {
  ...
  let initEnemy = {id: "testenemy", name: "spooky thing", stats: { health: 6, speed: 0.5, position: 0., damage: 1 }};
  let newEnemy = id => {id: id, name: id, stats: { health: 6, speed: 0.8, position: 0., damage: 1 }};
  let create = player => {
